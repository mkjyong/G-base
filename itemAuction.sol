...
contract itemAuction is ItemOwnership {
    ...
    /// auction is not won.
    function bid(uint gold) public payable {
        ...
        // money back.
        require(gold > highestBid);
        require(gold >= balanceOf[msg.sender]);
        ...
        highestBid = gold;
        emit HighestBidIncreased(msg.sender, gold);
    }
/*
    ...
    function auctionEnd() public {
        ...
        // 3. Interaction
        balances[beneficiary] = balances[beneficiary] + highestBid;
